...
export default buildModule("GameRentalSetup", (m) => {
    ...
    const regGame1 = m.call(gameRental, "registerGame", [1, 1000000000000000000n, 1000n, 1000n], { from: developer, id: "registerGame1" });
    const regGame2 = m.call(gameRental, "registerGame", [2, 2000000000000000000n, 1200n, 1000n], { from: developer, id: "registerGame2" });
